...
public abstract class Technology{
    ...
    public String toString() {
        String manufacturerDetails = (manufacturer != null) ? manufacturer.toString() : "Unknown Manufacturer";
        return "Model: " + modelName + ", Price: " + "€" + price + ", Manufacturer Details: " + manufacturerDetails + ", ID: " + id;
    }
